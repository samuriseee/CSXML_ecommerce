    ...
    public class NguoiDungController : Controller
    {
        ...
        public ActionResult Index(string SearchString)
        {
            ...
            foreach (XmlElement ele in xmlDoc.GetElementsByTagName("NguoiDung"))
            {
                ...
                nguoiDung.gioiTinh = ele.GetAttribute("gioiTinh");
        ...
        public void ToNguoiDungSQL()
        {
            ...
            foreach (DataRow dataRow in dt.Rows)
            {
                ...
                {
                    sql = "insert into NguoiDung(tenTaiKhoan, matKhau, maQuyen, ten, diaChi, SDT,  email, CMND, gioiTinh, trangThai)" +
                        ...
                        "', " + dataRow["gioiTinh"] + ", " + dataRow["trangThai"] + ")";
                    XmlToSQL.InsertOrUpDateSQL(sql);
                }
            }
        }
